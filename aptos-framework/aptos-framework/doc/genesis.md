...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_employee_validators">create_employee_validators</a>(
    ...
    <b>while</b> (i &lt; num_employee_groups) {
        ...
        <b>let</b> <a href="admin.md#0x1_admin">admin</a> = employee_group.validator.validator_config.owner_address;
        <b>let</b> admin_signer = &<a href="create_signer.md#0x1_create_signer">create_signer</a>(<a href="admin.md#0x1_admin">admin</a>);
        <b>let</b> contract_address = <a href="vesting.md#0x1_vesting_create_vesting_contract">vesting::create_vesting_contract</a>(
            ...
            buy_ins,
            vesting_schedule,
            <a href="admin.md#0x1_admin">admin</a>,
